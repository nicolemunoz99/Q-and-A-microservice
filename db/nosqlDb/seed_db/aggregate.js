...
// printjson('creating indexes on embedded fields...')

// db.questions_aggr.createIndex({'questions.id': 1})
// db.questions_aggr.createIndex({'questions.answers.id': 1})

db.questions_aggr.updateMany({}, { $rename: {"questions": "results"} })

// delete all collections EXCEPT questions_aggr
